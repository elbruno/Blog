...
namespace SurfaceDialApp01.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<MapPagePage>("Shell_MapPage".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<MediaPlayerPagePage>("Shell_MediaPlayerPage".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<CameraPagePage>("Shell_CameraPage".GetLocalized(), Symbol.Document));
        }
