...
namespace UwpAppYolo01
{
    public sealed partial class MainPage : Page
    {
        ...
        private MpsnnGraphModel _model;
        ...
        private async void LoadYoloOnnxModel()
        {
            ...
            var file = await Windows.Storage.StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///20180709 TinyYoloV3.onnx"));
            _model = await MpsnnGraphModel.CreateMpsnnGraphModel(file); //, 
        ...
        private async void CameraHelper_FrameArrived(object sender, Microsoft.Toolkit.Uwp.Helpers.FrameEventArgs e)
        {
            ...
            var input = new MpsnnGraphModelInput { Image = e.VideoFrame };
